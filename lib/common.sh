...
FAIL2BAN_IGNOREIP 'IP addresses or subnets that Fail2ban should ignore'
FAIL2BAN_BAN_TIME 'Ban time in seconds for Fail2ban'
FAIL2BAN_FINDTIME 'Find time window in seconds for Fail2ban'
FAIL2BAN_MAXRETRY 'Maximum retry attempts before Fail2ban ban'
...
ENABLE_BBR 'Whether to enable BBR congestion control (true/false)'
...
apply_config_defaults() {
    ...
    : "${MONITORING_PROMETHEUS_NODE_ENABLED:=false}"
